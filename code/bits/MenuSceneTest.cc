...
namespace rCMI
{
    Menu::Menu(RogueCMI &game)
        : gf::Scene(view_size),
          ...
          title(game.resources.getTexture("tileSetTexture.png"))
    {
        ...
        createButtons(choose_level, [&]()
                      { game.replaceAllScenes(game.m_WorldScene_L1, trans, gf::milliseconds(500)); });
        ...
        createButtons(credits, [&]()
                      { game.replaceAllScenes(game.m_WorldScene_L1, slide, gf::milliseconds(500)); });
    }
